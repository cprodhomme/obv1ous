...
teamMemberData = [
{name: 'Gaviil',id_steam: '76561198064635221',color: 'orange', avatar_color: 'orange', description: 'Moi ça va, si j\'écoute pas les voix qui me parle.<br>Ps: TA RACE', rank_cs: 'Master Guardian 2', rank_lol: 'Gold 5', role_cs: 'Open Frag', role_lol: 'Support'},
...
{name: 'Sweubi',id_steam: '76561198060575902', color: 'blue', avatar_color: 'blue', description: 'ave caesar morituri te salutant', rank_cs: 'Master Guardian 2', rank_lol: 'Platine 4', role_cs: 'Open frag', role_lol: 'ADC'},
...
{name: 'Kurtis',id_steam: '', color: 'purple', avatar_color: 'pink', description: ' ', rank_cs: 'Master Guardian 2', rank_lol: '', role_cs: 'Open frag', role_lol: ''},
{name: 'Harreen',id_steam: '76561198201786950', color: 'yellow', avatar_color: 'yellow', description: ' ', rank_cs: 'Gold nova1', rank_lol: '', role_cs: 'Open frag', role_lol: ''},
...
{team_member_id: 7, name_game: 'csgo'},
{team_member_id: 1, name_game: 'lol'},
{team_member_id: 3, name_game: 'lol'},
{team_member_id: 6, name_game: 'lol'},
...
{team_member_id: 6, name_game: 'rocket'},
...
{team_member_id: 7, name_game: 'minecraft'},
{team_member_id: 1, name_game: 'rust'},
{team_member_id: 2, name_game: 'rust'},
{team_member_id: 2, name_game: 'clicker'},
{team_member_id: 7, name_game: 'clicker'},
{team_member_id: 5, name_game: 'starcraft'},
{team_member_id: 1, name_game: 'darkest'},
{team_member_id: 3, name_game: 'darkest'}
]
...
{team_member_id: 5, name_weapon: 'AK-47'},
{team_member_id: 5, name_weapon: 'AWP'},
{team_member_id: 5, name_weapon: 'P250'},
{team_member_id: 6, name_weapon: 'AK-47'},
{team_member_id: 6, name_weapon: 'AWP'},
{team_member_id: 6, name_weapon: 'Five-seven'},
{team_member_id: 7, name_weapon: 'AK-47_cartel'},
{team_member_id: 7, name_weapon: 'Desert_Eagle_conspiration'},
{team_member_id: 7, name_weapon: 'M4A4_evil'}
]
